...
void ship_draw( const ship_t* ship )
{
  ...
  draw_triangle( ship->x + dx, ship->y + dy, //ORIGINAL
		  ship->x + lx, ship->y + ly,
		  ship->x + rx, ship->y + ry,
		  shipcolor );
     
  draw_triangle( ship->x + dx, ship->y + dy + 1, //top
   	  ship->x + lx, ship->y + ly + 1,
   		ship->x + rx, ship->y + ry + 1,
   		shipcolor );
     
  draw_triangle( ship->x + dx + 1, ship->y + dy + 1, //top right
       ship->x + lx + 1, ship->y + ly + 1,
       ship->x + rx + 1, ship->y + ry + 1,
       shipcolor );
          
  draw_triangle( ship->x + dx + 1, ship->y + dy, //right
        ship->x + lx + 1, ship->y + ly,
        ship->x + rx + 1, ship->y + ry,
        shipcolor );
              
  draw_triangle( ship->x + dx + 1, ship->y + dy - 1, //bot right
        ship->x + lx + 1, ship->y + ly - 1,
        ship->x + rx + 1, ship->y + ry - 1,
        shipcolor );
                  
  draw_triangle( ship->x + dx, ship->y + dy - 1, //bottom
        ship->x + lx, ship->y + ly - 1,
        ship->x + rx, ship->y + ry - 1,
        shipcolor );
                      
  draw_triangle( ship->x + dx - 1, ship->y + dy - 1, //bot left
        ship->x + lx - 1, ship->y + ly - 1,
        ship->x + rx - 1, ship->y + ry - 1,
        shipcolor );
                          
  draw_triangle( ship->x + dx - 1, ship->y + dy, //left
        ship->x + lx - 1, ship->y + ly,
        ship->x + rx - 1, ship->y + ry,
        shipcolor );
        
  draw_triangle( ship->x + dx - 1, ship->y + dy + 1, //top left
        ship->x + lx - 1, ship->y + ly + 1,
        ship->x + rx - 1, ship->y + ry + 1,
        shipcolor );
...
void roid_draw( const roid_t* roid )
{
  ...
  draw_rectangle(roid->x-roid->width/2.0,
  roid->y-roid->height/2.0,
  roid->x+roid->width/2.0,
  roid->y+roid->height/2.0,
  roid->color); //ORIGINAL
  ...
  */
  draw_rectangle(roid->x-roid->width/2.0,
  roid->y-roid->height/2.0 + 1,
  roid->x+roid->width/2.0,
  roid->y+roid->height/2.0 + 1,
  roid->color); //top

  draw_rectangle(roid->x-roid->width/2.0 + 1,
  roid->y-roid->height/2.0 + 1,
  roid->x+roid->width/2.0 + 1,
  roid->y+roid->height/2.0 + 1,
  roid->color); //top right
...
int shot_roid_hit( const shot_t* shot, const roid_t* roid )
{
  ...
  if (shot->x >= roid->x - roid->width/2 &&shot->x <= roid->x + roid->width/2 &&shot->y >= roid->y - roid->height/2 &&shot->y <= roid->y + roid->height/2 ){
	    return 1;
    }
    
  if (shot->x >= roid->x - roid->width/2 &&shot->x <= roid->x + roid->width/2 &&shot->y + 1 >= roid->y - roid->height/2 &&shot->y + 1 <= roid->y + roid->height/2 ){
  	  return 1;
    }
      
  if (shot->x + 1 >= roid->x - roid->width/2 &&shot->x + 1 <= roid->x + roid->width/2 &&shot->y + 1 >= roid->y - roid->height/2 &&shot->y + 1 <= roid->y + roid->height/2 ){
      return 1;
     }
        
  if (shot->x + 1 >= roid->x - roid->width/2 &&shot->x + 1 <= roid->x + roid->width/2 &&shot->y >= roid->y - roid->height/2 &&shot->y <= roid->y + roid->height/2 ){
      return 1;
      }
